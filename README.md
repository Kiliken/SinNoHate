...
A **high-speed, top-down arcade shooter** for the contest [Bandai Namco Studio Cup | Siv3D Game Jam 2025](https://siv3d.github.io/en-us/event/gamejam/) using the [OpenSiv3D](https://siv3d.github.io/en-us/) framework.
...
| Asset Use | Source / License | Composer / Track |
| :--- | :--- | :--- |
| **Title Music** | [Uppbeat.io](https://uppbeat.io/t/locran/lacrimosa-requiem-mozart) | Locran - *Lacrimosa Requiem* (Mozart) |
| **In-Game BGM** | [Archive.org](https://archive.org/details/lp_dante-symphony_franz-liszt-margit-lszlo-the-budapest-phil) | Franz Liszt - *Dante Symphony* |
